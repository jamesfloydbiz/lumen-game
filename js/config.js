...
const CONFIG = {
  ...
  build: {
    ...
    supply:  { name:'Supply Line',   accent:'wood', max:1, foot:1.0, snap:2.5, clear:6, gap:2.0, cost:()=>2, supply:true,
               stat:()=>({}), blurb:'A cheap link. Chain from the pile to a farm to power it.' },   // small footprint, fine 2.5 snap + tight gap so poles tuck into the corners around the pile
